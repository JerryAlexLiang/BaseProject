...
public class WebActivityX5 extends MVPBaseActivity<WebViewInterface, AgentWebPresenter> implements CustomPopupWindow.ViewInterface, View.OnClickListener, WebViewInterface {

    private static final String TAG = WebActivityX5.class.getSimpleName();
    ...
    @BindView(R.id.web_container_x5)
    WebContainerX5 webContainerX5;
...
//    private AgentWeb mAgentWeb;
    ...
    private WebHolderX5 mWebHolderX5;

    public static void actionStart(Context context, ArticleBean articleBean) {
        Intent intent = new Intent(context, WebActivityX5.class);
    ...
    private void initView() {
        ...
        mWebHolderX5 = WebHolderX5.with(this, webContainerX5)
                .setOnPageTitleCallback(title -> setTitle())
                .setOnPageLoadCallback(new WebHolderX5.OnPageLoadCallback() {
                    @Override
                ...
                .setOnPageProgressCallback(new WebHolderX5.OnPageProgressCallback() {
                    @Override
        ...
        mWebHolderX5.loadUrl(mUrl);

    }

    private void setTitle() {
        if (!TextUtils.isEmpty(mWebHolderX5.getTitle())) {
            baseActionbarTitle.setText(mWebHolderX5.getTitle());
        } else {
            baseActionbarTitle.setText(mWebHolderX5.getUrl());
        }
    }
...
//        customPopupWindow.showAtLocation(menuView, Gravity.TOP,0,0);
    ...
    protected void onResume() {
        mWebHolderX5.onResume();
        super.onResume();
    }

    @Override
    protected void onPause() {
        mWebHolderX5.onPause();
        super.onPause();
    }

    @Override
    protected void onDestroy() {
        mWebHolderX5.onDestroy();
        super.onDestroy();
    }

    @Override
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (mWebHolderX5.handleKeyEvent(keyCode, event)) {
            return true;
        }
