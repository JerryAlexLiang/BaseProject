package com.liang.module_core_java.widget.popupwindow;
...
public class CustomPopupWindow extends PopupWindow {
    ...
    public interface ViewInterface {
        void getChildView(View view, int layoutResId, int flag);
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder setViewOnclickListener(ViewInterface listener, int flag) {
        ...
        public CustomPopupWindow create() {
            ...
            if (listener != null && params.layoutResId != 0) {
                listener.getChildView(popupWindow.controller.mPopupView, params.layoutResId, flag);
            }
