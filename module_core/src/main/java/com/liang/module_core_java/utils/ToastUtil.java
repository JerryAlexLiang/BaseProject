...
import com.liang.module_core_java.widget.toast.CustomToast;
...
public class ToastUtil {
    ...
    public static void onShowToast(String content) {
        ToastUtil.setCustomToast(BaseApplication.getAppContext(), BitmapFactory.decodeResource(ResUtils.getResources(), R.drawable.icon_true),
                false, content, ResUtils.getResources().getColor(R.color.toast_bg), ResUtils.getResources().getColor(R.color.text_invert), Gravity.CENTER, Toast.LENGTH_SHORT);
    }

    public static void onShowTrueToast(String content) {
        ToastUtil.setCustomToast(BaseApplication.getAppContext(), BitmapFactory.decodeResource(ResUtils.getResources(), R.drawable.icon_true),
                true, content, ResUtils.getResources().getColor(R.color.toast_bg), ResUtils.getResources().getColor(R.color.text_invert), Gravity.CENTER, Toast.LENGTH_SHORT);
    }

    public static void onShowErrorToast(String content) {
        ToastUtil.setCustomToast(BaseApplication.getAppContext(), BitmapFactory.decodeResource(ResUtils.getResources(), R.drawable.icon_wrong),
                true, content, ResUtils.getResources().getColor(R.color.toast_bg), ResUtils.getResources().getColor(R.color.text_invert), Gravity.CENTER, Toast.LENGTH_SHORT);
    }
