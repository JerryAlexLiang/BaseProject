package com.liang.module_core.update.fragment;
...
/**
 * 创建日期: 2021/5/31 on 3:20 PM
 * 描述: 版本更新提示器【DialogFragment实现】
 * 作者: 杨亮
 */
public class CustomUpdateDialogFragment extends DialogFragment implements View.OnClickListener, IDownloadEventHandler {
    ...
    public static void show(@NonNull FragmentManager fragmentManager, @NonNull UpdateEntity updateEntity, @NonNull IPrompterProxy prompterProxy, @NonNull PromptEntity promptEntity) {
        CustomUpdateDialogFragment fragment = new CustomUpdateDialogFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.custom_xupdate_layout_update_prompter, container);
    }
...
//        DrawableUtils.setBackgroundCompat(mBtnBackgroundUpdate, DrawableUtils.getDrawable(UpdateUtils.dip2px(4, getContext()), themeColor));
    ...
    public void handleStart() {
        if (!CustomUpdateDialogFragment.this.isRemoving()) {
            doStart();
        }
    }
    ...
    private static void setsIPrompterProxy(IPrompterProxy sIPrompterProxy) {
        CustomUpdateDialogFragment.sIPrompterProxy = sIPrompterProxy;
    }
