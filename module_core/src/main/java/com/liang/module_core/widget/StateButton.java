...
/**
 * 创建日期：2019/6/28 on 14:44
 * 描述:自定义按钮  详情请参考https://github.com/niniloveyou/StateButton
...
//        this(context, attrs, androidx.appcompat.appcompat.R.attr.buttonStyle);
    ...
    private void setup(AttributeSet attrs) {
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.StateButton_state_btn_radius, 0);
        mRound = a.getBoolean(R.styleable.StateButton_state_btn_round, false);
