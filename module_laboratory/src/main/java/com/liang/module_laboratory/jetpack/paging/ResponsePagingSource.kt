 ...
 * 作者: 杨亮
 */
class ResponsePagingSource(private val pagingService: PagingService) : PagingSource<Int, PagingBean.ItemsBean>() {
     ...
     */
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, PagingBean.ItemsBean> {
        try {
            //默认设置为第1页
...
//            val pageSize = params.loadSize
            ...
            val repoResponse = pagingService.searchPagingResponse(page, pageSize)
    ...
    override fun getRefreshKey(state: PagingState<Int, PagingBean.ItemsBean>): Int? {
        return null
    }
