 ...
 * 作者: 杨亮
 */
class ResponsePagingAdapter2 : PagingDataAdapter<ArticleBean, ResponsePagingAdapter2.MyViewHolder>(COMPARATOR) {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (item != null) {
            holder.tvPagingTitle.text = item.title ?: ""
            holder.tvPagingContent.text = item.superChapterName + " - " + item.shareUser
            holder.tvPagingStarScore.text = "100"
        }
    }
