 ...
 * 作者: 杨亮
 */
class CommonMultipleSelectListFragment : MVVMBaseFragment() {

    private lateinit var dataList: MutableList<BookBean>
    private lateinit var defaultSelectDataList: MutableList<BookBean>
    private lateinit var adapter: CommonMultipleSelectListAdapter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter = CommonMultipleSelectListAdapter()
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
                CommonMultipleSelectListFragment()
    }
}